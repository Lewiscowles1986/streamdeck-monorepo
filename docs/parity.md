...
Status: **2026-09-20** — all rows implemented and regression-tested (toggle-mode editor + assign→render loop added 2026-09-20; P13 backend-only — its UI surface is deferred to the merge round).
